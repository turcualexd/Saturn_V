...
$\Delta h_s$ è direttamente legata al lavoro della pompa, rappresenta l'entalpia specifica del fluido di lavoro, anche nel caso di fluido con elevata comprimibilità, e si può sempre scrivere 
\begin{empheq}{equation*}
...
\begin{empheq}{gather*}
P = \dot{m}{(\omega R_2 )}^2{(1 - {\frac{v_{m2}}{\omega R_2}} {\tan \beta_{blp}})} = \dot{m}\frac{g H}{\eta_P}
\end{empheq}
...
\rfig{turbina_general}{Turbina ad impulso VC dell'F-1. Fonte: \cite{engine_manual_supplement}}{turbina_general}{0.45}
