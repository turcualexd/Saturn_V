...
\begin{empheq}{gather*}
             c^* =  \frac {p_{cc}  A_{t}} {\Gamma\ { \frac {p_{cc}}{\sqrt{{\frac {R}{MM}} T_{cc}}}  A_{t} }}          \\ 
...
\begin{empheq}{gather*}
         ...
         R_{cil} = \sqrt{\frac{A_{cil}}{\pi}}            \\       
         a = {R_{cil} - R_{t}}                                  \\
         L_{conv} = \frac {a}{\tan(\theta\ )}             \\ 
...
\begin{empheq}{gather*}
         fatt_{corr} = 1 + \%   \\
         L_{cil_c} = \frac {V_{cil}}{ fatt_{corr} A_{c}} \qquad
