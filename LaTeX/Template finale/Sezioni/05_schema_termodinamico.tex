...
\twofigII{staged_comb}{Staged Combustion Cycle FR}{staged_comb}{full_cycle}{Staged Combustion Cycle completo}{full_cycle}{0.6}
...
\mathcal{T} = \dot{m}_{p,tc} u_e + A_e \left( p_a - p_e \right)
\qquad \text{dove} \qquad
u_{e,tc} = u_{e,tc} \left( p_c \right) = \sqrt{\frac{2 \gamma R T_c}{\gamma - 1} \left[ 1 - \left( \frac{p_e}{p_c} \right) ^ {\frac{\gamma - 1}{\gamma}} \right]}
\end{empheq}
...
\begin{empheq}{equation*}
I_{s,tc} = \frac{\mathcal{T} \left( p_{c,tc} \right)}{\dot{m}_{p,tc}} = u_{e,tc} \left( p_{c,tc} \right) + \frac{A_e \left( p_a - p_{e,tc} \right)}{\dot{m}_{p,tc}}
\end{empheq}
...
\begin{empheq}{gather*}
I_{s,oa} = \left( 1 - \frac{\dot{m}_{p,gg}}{\dot{m}_p} \right) I_{s,tc} + \frac{\dot{m}_{p,gg}}{\dot{m}_p} I_{s,gg}
\qquad
I_{s,gg} = I_{s,gg} \left( u_{e,gg}, \, p_{c,gg}, \, \dot{m}_{p,gg} \right)
\\
I_{s,tc} = I_{s,tc} \left( u_{e,tc}, \, p_{c,tc}, \, \dot{m}_{p,tc} \right)
\qquad
p_{c,gg} = 0.85 \cdot p_{c,tc}
\\
u_{e,gg} = u_{e,gg} \left( p_{c,gg} \right) = \sqrt{\frac{2 \gamma_{gg} R_{gg} T_{c,gg}}{\gamma_{gg} - 1} \left[ 1 - \left( \frac{p_{e,gg}}{p_{c,gg}} \right) ^ {\frac{\gamma_{gg} - 1}{\gamma_{gg}}} \right]}
\qquad
\dot{m}_{p,gg} = \dot{m}_{p,gg} \left( \mathcal{P}, \, \eta_t, \, \epsilon, \, T_{in}, \, c_{p,gg} \right) = \frac{\mathcal{P}}{\eta_t \, c_{p,gg} \, T_{in} \, \epsilon}
\\
u_{e,tc} = u_{e,tc} \left( p_{c,tc} \right) = \sqrt{\frac{2 \gamma_{tc} R_{tc} T_{c,tc}}{\gamma_{tc} - 1} \left[ 1 - \left( \frac{p_{e,tc}}{p_{c,tc}} \right) ^ {\frac{\gamma_{tc} - 1}{\gamma_{tc}}} \right]}
\qquad
\dot{m}_{p,tc} = \dot{m}_p - \dot{m}_{p,gg}
\\
\mathcal{P} = \mathcal{P}_{LOX} + \mathcal{P}_{RP1} = \frac{\Delta p_{LOX} \, \dot{m}_{LOX}}{\eta_{p,LOX} \, \rho_{LOX}} + \frac{\Delta p_{RP1} \, \dot{m}_{RP1}}{\eta_{p,RP1} \, \rho_{RP1}}
\end{empheq}

\rfig{I_spec_see}{Confronto tra impulsi specifici a livello mare}{I_spec_see}{0.35}
