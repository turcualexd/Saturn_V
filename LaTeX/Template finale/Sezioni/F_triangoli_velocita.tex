...
\begin{empheq}{gather*}
\overrightarrow{u_{0 ind}} = 89.2475 \overrightarrow {i_u} + 0 \overrightarrow {i_m}\\
\overrightarrow{v_{0 ind}} = -89.2475 \overrightarrow {i_u} + 11.8311 \overrightarrow {i_m}\\
\overrightarrow{c_{0 ind}} = 0 \overrightarrow {i_u} + 11.8311 \overrightarrow {i_m}\\
\end{empheq}
\begin{empheq}{gather*}
\overrightarrow{u_{1 ind}} = 86.1918 \overrightarrow {i_u} + 0 \overrightarrow {i_m}\\
\overrightarrow{v_{1 ind}} = -76.4706 \overrightarrow {i_u} + 16.8556 \overrightarrow {i_m}\\
\overrightarrow{c_{1 ind}} = 9.7212 \overrightarrow {i_u} + 16.8556 \overrightarrow {i_m}\\
\end{empheq}
\begin{empheq}{gather*}
\overrightarrow{u_{1 imp}} = 115.3671 \overrightarrow {i_u} + 0 \overrightarrow {i_m}\\
\overrightarrow{v_{1 imp}} = -70.9707 \overrightarrow {i_u} +   12.5769 \overrightarrow {i_m}\\
\overrightarrow{c_{1 imp}} = 44.3964 \overrightarrow {i_u} + 12.5769 \overrightarrow {i_m}\\
\end{empheq}
\begin{empheq}{gather*}
\overrightarrow{u_{2 imp}} =  142.4285 \overrightarrow {i_u} + 0 \overrightarrow {i_m}\\
\overrightarrow{v_{2 imp}} = -44.6393 \overrightarrow {i_u} + 18.8654 \overrightarrow {i_m}\\
\overrightarrow{c_{2 imp}} = 97.7891 \overrightarrow {i_u} + 18.8654 \overrightarrow {i_m}\\
\end{empheq}
...
\begin{empheq}{gather*}
\overrightarrow{u_{0 ind}} = 73.1802 \overrightarrow {i_u} + 0 \overrightarrow {i_m}\\
\overrightarrow{v_{0 ind}} = -73.1802 \overrightarrow {i_u} + 10.6488 \overrightarrow {i_m}\\
\overrightarrow{c_{0 ind}} = 0 \overrightarrow {i_u} + 10.6488 \overrightarrow {i_m}\\
\end{empheq}
\begin{empheq}{gather*}
\overrightarrow{u_{1 ind}} = 70.6747 \overrightarrow {i_u} + 0 \overrightarrow {i_m}\\
\overrightarrow{v_{1 ind}} = -62.7036 \overrightarrow {i_u} + 15.1711 \overrightarrow {i_m}\\
\overrightarrow{c_{1 ind}} = 7.9711 \overrightarrow {i_u} + 15.1711 \overrightarrow {i_m}\\
\end{empheq}
\begin{empheq}{gather*}
\overrightarrow{u_{1 imp}} = 138.1757 \overrightarrow {i_u} + 0 \overrightarrow {i_m}\\
\overrightarrow{v_{1 imp}} = -60.8308 \overrightarrow {i_u} +   5.2854 \overrightarrow {i_m}\\
\overrightarrow{c_{1 imp}} = 77.3449 \overrightarrow {i_u} + 5.2854 \overrightarrow {i_m}\\
\end{empheq}
\begin{empheq}{gather*}
\overrightarrow{u_{2 imp}} =  170.5873 \overrightarrow {i_u} + 0 \overrightarrow {i_m}\\
\overrightarrow{v_{2 imp}} = -18.7596 \overrightarrow {i_u} + 7.9282 \overrightarrow {i_m}\\
\overrightarrow{c_{2 imp}} = 151.8276 \overrightarrow {i_u} + 7.9282 \overrightarrow {i_m}\\
\end{empheq}
