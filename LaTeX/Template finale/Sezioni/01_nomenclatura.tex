...
\begin{multicols}{2}
	...
	\begin{tabular}{ccl}
		...
		$\bm{g}$ & $[m/s^2]$ & accelerazione di gravità \\
                ...
                $\bm{H}$ & $[m]$ & head rise – prevalenze della pompa \\
		...
		$\bm{N_{SS}}$ & $[-]$ & suction specific velocity \\
                $\bm{NPSH}$ & $[m]$ & net positive suction head \\
                $\bm{NPSH_c}$ & $[m]$ & net positive suction head critico \\
		$\bm{\Delta P}$ & $[bar]$ & salto di pressione a cavallo della pompa \\
		$\bm{P_{TOT 0}}$ & $[bar]$ & pressione totale all'ingresso della pompa \\
                $\bm{P_{TOT 2}}$ & $[bar]$ & pressione totale all'uscita dalla pompa \\
	        $\bm{P_{vap}}$ & $[bar]$ & pressione di vapore \\
		$\bm{P}$ & $[W]$ & potenza \\
		...
		$\bm{pedice_m}$ & $[-]$ & componente meridionale della velocità \\
                ...
                $\bm{Q}$ & $[m^3/s]$ & portata volumetrica \\
