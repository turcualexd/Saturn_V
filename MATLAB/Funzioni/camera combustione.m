...
% il convergente come 15% del volume della porzione
...
% p_c_psi = p_c/6895
% R_c_in = R_c * 39.37
% t_w = p_c_psi*2*R_c_in/16000; % spessore della parete minimo
% S = (p_c*2*R_c)/(2*t_w); % sollecitazione di lavoro della parete
% 
% t_w_m = t_w / 39.37
